...
class LiftingCalculatorWidget(QWidget):
    """Calculator for lifting verification with strands."""
    ...
    def _recalculate(self) -> None:
        ...
        if is_approved:
            ...
            self._show_status("Reprovada | " + ", ".join(failures), 9000)
